...
import 'package:core_flutter/shared/widgets/positioned_all.dart';
import 'package:core_flutter/shared/widgets/rounded_card.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:provider/provider.dart';

import 'package:core_flutter/shared/extensions/string_extension.dart';
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                borderRadius: widget.cornerRadius != null ? BorderRadius.circular(widget.cornerRadius!) : Corners.medBorder, boxShadow: shadows),
            child: TextButton(
              ...
              style: ElevatedButton.styleFrom(disabledMouseCursor: SystemMouseCursors.basic).copyWith(
                ...
                side: getMaterialState(normal: BorderSide(color: normalColors.outline), hover: BorderSide(color: hoverColors.outline)),
...
class BtnContent extends StatelessWidget {
  const BtnContent({Key? key, this.label, this.icon, this.child, this.leadingIcon = false, this.isCompact = false, this.labelStyle})
      : super(key: key);
  final Widget? child;
  final String? label;
  final IconData? icon;
