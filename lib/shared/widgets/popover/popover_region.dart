...
class PopOverRegion extends StatefulWidget {
  PopOverRegion(
      {Key? key, required this.child, required this.popChild, this.anchor, this.popAnchor, this.barrierDismissable, this.barrierColor, this.mode})
      : super(key: key);
  final Widget child;
  ...
  static PopOverRegion hover({required Widget child, required Widget popChild, Alignment? anchor, Alignment? popAnchor, Key? key}) {
    return PopOverRegion(key: key, child: child, popChild: popChild, anchor: anchor, popAnchor: popAnchor, mode: PopOverRegionMode.Hover);
  }
