...
import 'package:core_flutter/shared/utils/native_window_utils/macos_window_utils.dart';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<double>(
        ...
        builder: (BuildContext context, AsyncSnapshot<double> snapshot) {
          double? height = snapshot.connectionState == ConnectionState.done ? snapshot.data : MacosWindowUtils.kDefaultTitlebarHeight;
